...
const Header = () => {
  return (
    <header className="max-w-7xl mx-auto py-4 sticky top-0 z-50 backdrop-blur md:backdrop-blur-none">
        <div className="flex justify-between items-center  md:p-2.5 rounded-xl  relative">
          <div>
            <Link href={"/"}>
              <p
